...
class Loan():
    ...
    def get_emi(self):
        ...
        try:
            ...
            return math.trunc(math.ceil(float(repay_amount)/(self.no_Of_years*12)))
        except:
    ...
    def get_total_emi_nos(self):
       ...
       # Formula to find the count of emi's within the loan no_Of_years
        
        try:
            return math.trunc(math.ceil(self.no_Of_years*12))
        except:
    ...
    def get_lumpsum_amount_paid(self, emi_number):
        ...
        try:
            ...
            logger.warning("Error in finding total lmumpsum amount")
